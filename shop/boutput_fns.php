...
?>
  ...
  <?php
     if(isset($_SESSION['admin_user'])) {
        echo "欢迎您！ ".$_SESSION['admin_user'];//echo "&nbsp;";
     } 
	 else if(isset($_SESSION['valid_user'])) {
       echo "总数 = ".$_SESSION['items'];
     }else {
       //echo "总数 = ".$_SESSION['items'];
     }
  ?>
  ...
  <?php
     if(isset($_SESSION['admin_user'])) {
      ...
      echo "总价 = $".number_format($_SESSION['total_price'],2);
     }
	 else {
       //echo "总价 = $".number_format($_SESSION['total_price'],2);
     }
...
?>
  ...
  <tr>
    <td colspan="2" align="center"><p><strong>请点击购买按钮进行购买，或者点击返回继续购买.</strong></p>
...
?>
  <table border="0" width="100%" cellspacing="0">
  <tr><td align="left">运费</td>
      <td align="right"> <?php echo number_format($shipping, 2); ?></td></tr>
  <tr><th bgcolor="#cccccc" align="left">总价（包括运费）</th>
...
?>
  ...
  <tr><th colspan="2" bgcolor="#cccccc">卡信息</th></tr>
  <tr>
    <td>类型</td>
...
?>
<br />
<a href="index.php" >进入目录管理</a><br />
<a href="insert_category_form.php" >增加目录</a><br />
<a href="insert_book_form.php" >增加书籍</a><br />
<a href="change_password_form.php" >修改管理员密码</a><br />
<?php
}
